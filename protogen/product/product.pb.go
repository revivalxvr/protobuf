...
func (x *RollbackStocksReq) GetProductOrders() []*ProductOrder {
	if x != nil {
		return x.ProductOrders
	}
	return nil
...
const file_proto_product_type_product_proto_rawDesc = "" +
	...
	"\rproductOrders\x18\x01 \x03(\v2\x1a.product.type.ProductOrderR\x0eproducts_order\"V\n" +
	"\x11RollbackStocksReq\x12A\n" +
...
var file_proto_product_type_product_proto_depIdxs = []int32{
	...
	0, // 1: product.type.RollbackStocksReq.productOrders:type_name -> product.type.ProductOrder
